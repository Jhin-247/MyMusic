...
public class ImageHelper {
    ...
    public static void setImage(Context context, ImageView view, String resource) {
        if (resource == null || resource.equals("")) {
            Glide.with(context).load(R.drawable.notes).apply(RequestOptions.circleCropTransform()).into(view);
        }
        else {
    ...
    public static void setImageNormalSize(Context context, ImageView view, String resource) {
        if (resource == null || resource.equals(""))
            Glide.with(context).load(R.drawable.notes).into(view);
        else
